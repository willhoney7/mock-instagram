...
const handlePrerenderError = (err, env, stack, entry) => {
	...
	let sourceMapContent = JSON.parse(_fs2.default.readFileSync(`${entry}.map`));
	...
	let sourcePath = (0, _path.resolve)(env.src, position.source);
	let sourceLines = _fs2.default.readFileSync(sourcePath, 'utf-8').split('\n');
