...
exports.default = env => {
	...
	return (0, _webpack.group)([(0, _webpack.setContext)(src('.')), (0, _webpack.customConfig)({
		...
		module: {
			loaders: [{
				...
				use: [{
					...
					loader: (0, _path.resolve)(__dirname, './dependency-install-loader'),
					options: {
		...
		options: {
			postcss: () => [(0, _autoprefixer2.default)({ browsers })],
...
const development = () => (0, _webpack.group)([]);

const production = () => (0, _webpack.addPlugins)([new _webpack.webpack.HashedModuleIdsPlugin(), new _webpackChunkHash2.default(), new _webpack.webpack.LoaderOptionsPlugin({
	minimize: true
...
function helpers(env) {
	return {
		...
		src: dir => (0, _path.resolve)(env.cwd, env.src || 'src', dir)
	};
}